...
void NpcAirplane::Start()
{
	...
	Npc_Airplane_Back->GetTransform()->AddLocalPosition({ -200,-230 });
	...
	Npc_Airplane_Reg->GetTransform()->AddLocalPosition({ -200,-230 });
	...
	Npc_Airplane_Front->GetTransform()->AddLocalPosition({ -200,-230 });
	...
	Npc_Airplane_Spin->GetTransform()->AddLocalPosition({ -200,-230 });
	...
	Npc->GetTransform()->AddLocalPosition({ -200,-230 });
